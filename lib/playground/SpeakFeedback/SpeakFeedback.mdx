...
import SpeakFeedback from "./SpeakFeedback.stories.tsx";

<Meta of={SpeakFeedback} />

# **useSpeakFeedback**

This hook use speech synthesis to give feedback if you need to tell something important to
        know. Please, check it out!

## **Resources** :

- [Notifications and Feedback](https://www.w3.org/WAI/perspective-videos/notifications/)
- [Cognitive Accessibility Design Pattern: Provide Feedback](https://www.w3.org/WAI/WCAG2/supplemental/patterns/o4p10-status-feedback/)
