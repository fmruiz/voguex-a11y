...
import SpeakReader from "./SpeakReader.stories.tsx";

<Meta of={SpeakReader} />

# **useSpeakReader**

This hook is use speech synthesis to read short messages, or any element content, and with this make more accessible your application!
